        ...
        <div className="fixed inset-0 flex -mt-64 items-center justify-center z-50 backdrop-blur-2xl backdrop-filter dark:backdrop-blur-xl dark:backdrop-filter">
            <div className="bg-transparent w-96 rounded-xl p-6 transition-opacity duration-300">
                {loading ? <LoadingSpinner background='bg-transaprent' /> : <div className="relative p-4 text-center bg-white rounded-xl shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <p className="mb-2 text-2xl font-semibold text-gray-900 dark:text-white">Exchange Funds</p>
                    ...
                    {inProgress ? <div><span className='text-lg italic dark:text-white mb-12'>Processing transaction...<br /><br />
                        ...
                        <form onSubmit={handleSubmit} className="py-2 dark:bg-gray-800">
                            <p className='text-lg dark:text-white mb-6 text-center font-medium'>Current balance: {balanceState.toFixed(4)} {currency}</p>
                            <div className="mb-4">
                            <label
                                htmlFor="first_name"
